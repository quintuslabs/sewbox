           				...
           				<div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h3 class="page-title">Edit Alteration <small> Edit Alteration Data.</small></h3> 
								        ...
								        <div class="panel-body">                            
				                        	<div class='row'>
				                        		<div class="col-md-6 col-md-offset-3"> 
						                            {!! Form::model($alteration, ['route'=>['alterations.update', $alteration->id], 'method'=>'PATCH', 'class'=>'form-horizontal m-b-30']) !!}
						                                ...
						                                <div class="form-group">
						                                    ...
						                                    <div class="col-md-12">
						                                         {!! Form::textarea('comment', null, ['rows'=>'2', 'class'=>'form-control', 'placeholder'=>'Enter Comment Details','required']) !!}
						                                    </div>
						                                </div>
						                                <div class="form-group">
