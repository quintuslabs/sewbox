                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="clearfix">
                                            <div class="pull-left">
                                                <h3><img src="{{ asset($setting->logo)}}" alt="" height="80">{{ $setting->title }}</h3>
                                            </div>
                                            <div class="pull-right m-t-30 text-right">
                                                <h4 class="m-b-0">Company COPY</h4>
                                                <p>Payment ID: W-1</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                                    ...
                                                    <table class="table m-t-30 table-colored table-info">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="text-right">
                                                                    <strong>Rs. {{ $salary->salary_paid }}</strong>
                                                                </td>                                                        
                                                            </tr>                                 
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div class="clearfix">
                                            <div class="pull-left">
                                                <img src="{{ asset($setting->logo)}}" alt="" height="80"> {{ $setting->title }}
                                            </div>
                                            <div class="pull-right m-t-30 text-right">
