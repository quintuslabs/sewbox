								        ...
								        <div class="panel-body">                            
				                        	<div class='row'>
				                        		<div class="col-md-6 col-md-offset-3"> 
						                            {!! Form::open(['route'=>'staffs.store', 'class'=>'form-horizontal m-b-30','files' => true]) !!}
						                                ...
						                                <div class="form-group">
						                                    ...
						                                    <div class="col-md-12">
						                                         {!! Form::text('staff_name', '', ['class'=>'form-control', 'placeholder'=>'Enter Staff Name','onkeypress'=>'return (event.charCode > 64 && 
						                                ...
						                                <div class="form-group">    
						                                    ...
						                                    <div class="col-md-12">
						                                         {!! Form::text('staff_phone', '', ['class'=>'form-control', 'placeholder'=>'Enter Staff Phone','required', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'10',]) !!}
						                                    </div>
						                                </div>
						                                <div class="form-group">
														...
														<div class="row">
                                                            <div class="col-sm-6">
																<div class="form-group">
																	...
																	<div class="col-md-12">
																		{!! Form::date('dob', '', ['type'=>'date', 'class'=>'form-control', 'placeholder'=>'Enter Staff DOB','required']) !!}
																	</div>
																</div>
															</div>															
                                                            <div class="col-sm-6">
																<div class="form-group">
																	...
																	<div class="col-md-12">
																		{!! Form::date('doj', '', ['type'=>'date', 'class'=>'form-control', 'placeholder'=>'Enter Staff DOJ','required']) !!}
																	</div>
																</div>
															</div>
														</div>
