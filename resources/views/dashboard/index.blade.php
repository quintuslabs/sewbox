...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div style="background: url('{{ asset('images/bg3.jpg') }}'); margin: 0px -20px; background-position: center;">
                                    <div style="background-color: rgba(62, 74, 89, 0.69);">
                                        <div class="page-title-box" style="margin: 0; margin-bottom: 20px; background-color: transparent;">
                                            <div class="col-lg-12 m-t-40">
                                                <h2 class="text-white m-b-0" id="header-text">Dashboard</h2>
                                            </div>
                                            <div class="col-sm-6 col-md-6 col-xs-12">
                                                <p class="text-muted" id="sub-header-text" style="font-size: 20px; font-weight: 800 ">Welcome Administrator</p>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card-box widget-box-one">
                                            <div class="wigdet-one-content">
                                                ...
                                                <h2 class="text-warning"><span data-plugin="counterup">Rs. {{$order_month_total}}</span></h2>
                                                <p class="text-muted m-0"><b>CURRENT MONTH</b></p>
                                            </div>
                                        </div>
                                    </div>    
                                    <div class="col-md-4">    
                                        <div class="card-box widget-box-one">
                                            <div class="wigdet-one-content">
                                                ...
                                                <h2 class="text-success"><span data-plugin="counterup">Rs. {{$order_month_paid}}</span></h2>
                                                <p class="text-muted m-0"><b>CURRENT MONTH</b></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">    
                                        <div class="card-box widget-box-one">
                                            <div class="wigdet-one-content">
                                                ...
                                                <h2 class="text-danger"><span data-plugin="counterup">Rs. {{$order_month_due}}</span></h2>
                                                <p class="text-muted m-0"><b>CURRENT MONTH</b></p>
                                            </div>
                                        </div>
                                    </div>
